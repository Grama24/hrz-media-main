...
const Pachete = () => {
  return (
    <div className='h-auto  pt-16 mx-auto pachete'>
      ...
      <ComponentPachete pachet="PACHET FULL" pret="2350€/lună" serviciu1="Pachet light" serviciu2="+" serviciu3="Creare conținut video" serviciu4="20-25 videoclipuri lunar" serviciu5="3-5 zile de filmare pe lună" serviciu6="" serviciu7="" culoare="#663aa9" buton="Află mai multe" url="/servicii" ></ComponentPachete>
